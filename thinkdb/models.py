...
class MySQL_Status(db.Model):
    ...
    is_master = db.Column(db.SmallInteger, nullable=False, default=0, server_default='0', comment="是否主库,0否1是")
    is_slave = db.Column(db.SmallInteger, nullable=False, default=0, server_default='0', comment="是否从库,0否1是")
    uptime = db.Column(db.Integer,nullable=False,default=1, server_default='1',comment="在线时长")
    version = db.Column(db.String(16), nullable=False, default='', server_default='', comment="版本号")
    max_connection = db.Column(db.Integer,nullable=False,default=1,server_default='1',comment="最大连接数")
    max_connect_errors = db.Column(db.Integer,nullable=False,default=1,server_default='1',comment="最大连接数")
    open_files_limit = db.Column(db.Integer,nullable=False,default=1,server_default='1',comment="最大打开文件数")
    open_files = db.Column(db.Integer,nullable=False,default=1,server_default='1',comment="当前打开文件数")
    table_open_cache = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="表缓存数")
    open_tables = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="当前打开表数")
    opened_tables = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="当前打开表数")
    max_tmp_tables = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="临时表限制")
    max_heap_table_size = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="内存临时表限制")
    max_allowed_packet = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="Packet大小")
    threads_connected = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="当前打开线程数")
    threads_running = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="当前活动线程数")
    threads_created = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="创建的线程数量")
    threads_cached = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="线程缓存数量")
    connections = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="连接数")
    aborted_clients = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="断开客户端数量")
    aborted_connects = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="断开的连接数")
    created_tmp_tables = db.Column(db.SmallInteger, nullable=False, default=1, server_default='1',comment="创建的临时表数量")
    created_tmp_disk_tables = db.Column(db.SmallInteger, nullable=False, default=1, server_default='1',comment="创建的磁盘临时表数量")
    connections_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒连接数")
    bytes_received_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒接收字节数")
    bytes_sent_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒发送字节数")
    com_select_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒查询量")
    com_insert_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒写入量")
    com_update_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒更新量")
    com_delete_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒删除量")
    com_commit_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒提交数")
    com_rollback_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒回滚")
    questions_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒处理的客户端发送的请求数")
    queries_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒处理的请求数包括存储过程，事件等")
    transaction_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒事务数")
    created_tmp_tables_persecond = db.Column(db.SmallInteger, nullable=False, default=1, server_default='1', comment="每秒创建的临时表")
    created_tmp_disk_tables_persecond = db.Column(db.SmallInteger, nullable=False, default=1, server_default='1', comment="每秒创建的磁盘临时表")
    created_tmp_files_persecond = db.Column(db.SmallInteger, nullable=False, default=1, server_default='1', comment="每秒创建的临时文件数")
    table_locks_immediate_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒获得锁数量")
    table_locks_waited_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="每秒的锁等待")
    #InnoDB
    innodb_buffer_pool_pages_total = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="InnoDB总页数")
    innodb_buffer_pool_pages_data = db.Column(db.SmallInteger, nullable=False, default=1, server_default='1',comment="InnoDB使用中的页数量")
    innodb_buffer_pool_pages_dirty = db.Column(db.SmallInteger, nullable=False, default=1, server_default='1',comment="InnoDB脏数据的页数量")
    innodb_buffer_pool_pages_flushed = db.Column(db.SmallInteger, nullable=False, default=1, server_default='1',comment="缓冲池请求刷新的页数量")
    innodb_buffer_pool_pages_free = db.Column(db.Integer, nullable=False, default=1, server_default='1',comment="空闲页数量")
    innodb_buffer_pool_reads = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="Innodb从磁盘读取数")
    innodb_buffer_pool_read_requests = db.Column(db.Integer, nullable=False, default=1, server_default='1',comment="Innodb从缓冲读取数")
    innodb_row_lock_current_waits = db.Column(db.Integer, nullable=False, default=1, server_default='1',comment="InnoDB当前锁等待数")
    innodb_row_lock_time_avg = db.Column(db.Integer, nullable=False, default=1, server_default='1',comment="平均锁等待时长毫秒")
    innodb_row_lock_waits = db.Column(db.Integer, nullable=False, default=1, server_default='1',comment="Innodb锁等待总量")
    innodb_row_lock_time_max = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="InnoDB最大锁等待时长毫秒")
    innodb_rows_inserted_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1',comment="InnoDB每秒新增行数")
    innodb_rows_deleted_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="InnoDB每秒删除行数")
    innodb_rows_updated_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1', comment="InnoDB每秒更新行数")
    innodb_rows_reads_persecond = db.Column(db.Integer, nullable=False, default=1, server_default='1',comment="InnoDB每秒查询行数")
    add_time = db.Column(db.DateTime,default=datetime.now,comment="添加时间")
    last_modify_time = db.Column(db.DateTime,default=datetime.now,onupdate=datetime.now,comment="最后更新时间")
    def __repr__(self):
...
class MySQL_Status_History(db.Model):
    ...
    id = db.Column(db.Integer,primary_key=True,autoincrement=True,comment="自增主键")
    mysql_status_id = db.Column(db.Integer,comment="status表的主键,可以不用要，主要为了简化监控脚本的语句")
